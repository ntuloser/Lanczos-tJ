...
int main(){
    ...
    /*
    k = kh_put(kMap, h, 5000000000, &ret);
    kh_value(h, k) = 10.232323;
    k = kh_get(kMap, h, 5000000000);
    ...
    */
    ...
    dur_kFindInsert = ( std::clock() - start ) / (double) CLOCKS_PER_SEC;
    dur_kFindInsert -= dur_tonumber;
    dur_kFindInsert -= dur_swap;
    dur_kFindInsert -= dur_copy;
    ...
    cout<<"dur_kFindInsert : "<<dur_kFindInsert<<endl;
